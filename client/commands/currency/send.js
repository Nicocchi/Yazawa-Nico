...
exports.run = async (client, message, args, level) => {
  try {
    ...
    // Set the send
    const res = await axios.post(`${process.env.BE_URL}/users/send`, {'discord_id': message.author.id, 'name': message.author.username, 'mentioned_id': user.id, 'sendAmount': amount, 'mentioned_name': user.displayName });

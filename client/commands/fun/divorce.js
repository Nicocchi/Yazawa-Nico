...
exports.run = async (client, message, args, level) => {
  ...
  const res = await axios.post(`${process.env.BE_URL}/users/divorce`, {'discord_id': message.author.id, 'name': message.author.username, 'mentioned_id': user.id, 'mentioned_name': user.displayName });
